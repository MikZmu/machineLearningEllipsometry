...
training_class.train_model(model, loss, optimizer, x_train=half_standarized_data[0], y_train=half_standarized_data[1], x_test=half_standarized_data[2], y_test=half_standarized_data[3], save_path='modelBstandard_48_32_24_12.pth', batch_size=0)
